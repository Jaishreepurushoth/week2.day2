...
public class LeadEdit {
	...
	public static void main(String[] args) throws InterruptedException  {
		...
		driver.findElement(By.xpath("(//div[@class='x-form-element'])[19]/input")).sendKeys("Jaishree");
		driver.findElement(By.xpath("(//div[@class='x-form-element'])[20]/input")).sendKeys("Purushoth");
